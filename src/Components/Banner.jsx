...
function Banner() {
  return (
    <>
      <div className=' mas-w-screen-2xl container mx-auto md:px-0 px-4 flex flex-col md:flex-row  my-10'>
        <div className='w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32'>
        <div className='space-y-12'>
        <h1 className='text-4xl font-bold'>Great reads, <span className='text-blue-500'> one click away.</span></h1>
        <p text-xl >Welcome to your personal bookspace—where stories live, ideas thrive, 
                    and every shelf has something just for you. Whether it's fiction, facts, 
